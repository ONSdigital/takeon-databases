...
(
    ...
    Survey              Varchar(4) References dev01.Survey(Survey),
    Description         Varchar(128) Not Null,
...
Create Index idx_formdefinition_question On dev01.FormDefinition(QuestionCode);
...
Create Index idx_contributor_periodsurvey On dev01.Contributor(period, survey);
Create Index idx_contributor_surveyreference On dev01.Contributor(survey, reference);
...
(
    ...
    Period                 Char(6) Not Null,
    Survey                 Char(3) References dev01.Survey(Survey),
    ...
    Foreign Key (Reference, Period, Survey) References dev01.Contributor (Reference, Period, Survey),
    Foreign Key (Survey, QuestionCode) References dev01.Question (Survey, QuestionCode)
);
...
Create Index idx_validationform_question On dev01.ValidationForm(QuestionCode);
...
(
    ValidationID    Int References dev01.ValidationForm(ValidationID),
    AttributeName   Varchar(32) References dev01.ValidationAttribute(AttributeName),
...
(
    ...
    Reference           Varchar(11) Not Null,
    Period              Char(6) Not Null,
    Survey              Char(6) References dev01.Survey(Survey),
    ValidationID        BigInt References dev01.ValidationForm(ValidationID),
...
Create Index idx_validationoutput_referenceperiodsurvey On dev01.ValidationOutput(Reference, Period, Survey);

Delete From dev01.Survey;
...
Values
    ...
    ('076','101',current_user, Now()),
    ('076','102',current_user, Now()),
    ('076','103',current_user, Now()),
    ('076','104',current_user, Now()),
    ('076','111',current_user, Now()),
    ('076','112',current_user, Now()),
    ('076','113',current_user, Now()),
    ('076','114',current_user, Now()),
    ('076','121',current_user, Now()),
    ('076','122',current_user, Now()),
    ...
    ('073','147',current_user, Now()),
    ('073','148',current_user, Now()),
    ('073','608',current_user, Now()),
    ('073','607',current_user, Now()),
    ('073','606',current_user, Now()),
    ('073','605',current_user, Now()),
    ('073','604',current_user, Now()),
...
Delete From dev01.ValidationPeriod;
...
Delete From dev01.ValidationForm;
...
Delete From dev01.ValidationAttribute;
